...
```
###### \src\main\resources\view\PersonPanel.fxml
``` fxml
...
```
###### \src\test\java\guitests\guihandles\PersonPanelHandle.java
``` java
...
```
###### \src\test\java\seedu\address\ui\PersonPanelTest.java
``` java
