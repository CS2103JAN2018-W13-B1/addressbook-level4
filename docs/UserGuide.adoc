...
Command Alias: `f KEYWORD [MORE KEYWORDS]`
...
Command Alias: `gf KEYWORD [MORE_KEYWORDS]`
...
Command Alias: `pf KEYWORD [MORE_KEYWORDS]`
...
Command Alias: `pd PREFERENCE_NAME`
...
Command Alias: `ea t/TITLE [sd/START_DATE] ed/END_DATE [st/START_TIME] et/END_TIME` +
...
Command Alias: `ee e/ENTRY_INDEX [t/TITLE] [sd/START_DATE] [ed/END_DATE] [st/START_TIME] [et/END_TIME]` +
