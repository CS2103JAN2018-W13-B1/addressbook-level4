...
* *Undo* : `undo`
* *Redo* : `redo`
* *TopCustomers: `topcustomers NUMBER`
* *TopItems: `topitems NUMBER`
* *SendPromoGroup: `sendpromogroup GROUP... [sub/SUBJECT] [b/BODY]`
* *SendPromoPref: `sendpromopref PREFERENCE... [sub/SUBJECT] [b/BODY]`
* *Exit* : `exit`
