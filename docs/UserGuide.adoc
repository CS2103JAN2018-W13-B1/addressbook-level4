...
=== Exporting all listed persons : `exportCSV`

Exports all listed persons from the address book into Comma Separated Values file format. +
File will be stored to "data/exportedFile/" folder +
Format: `exportCSV` +
Alias: `exCSV`
...
* *Export to CSV file* : `exportCSV FILENAME` +
e.g. `exportCSV exportedDataFIle`
